...
M_DECLARE_AST_LEAF_NODE_ENUM(todo, TODO);
M_DECLARE_AST_LEAF_NODE_ENUM(storage_class_specifier, TYPEDEF, EXTERN, STATIC, AUTO, REGISTER);
M_DECLARE_AST_LEAF_NODE_ENUM(type_qualifier, CONST, RESTRICT, VOLATILE);
M_DECLARE_AST_LEAF_NODE_ENUM(function_specifier, INLINE);
M_DECLARE_AST_LEAF_NODE_ENUM(literal_pointer, LITERAL_POINTER);
...
M_DECLARE_AST_LEAF_NODE_ENUM(unary_operator, PRE_INC, PRE_DEC, POST_INC, POST_DEC, SIZEOF, ARRAY_SUBSCRIPT,
		UNARY_PLUS, UNARY_MINUS, LOGICAL_NOT, BITWISE_NOT, DEREFERENCE, ADDRESS_OF, FUNCTION_CALL);
M_DECLARE_AST_LEAF_NODE_ENUM(assignment_operator, BASIC_ASSIGNMENT);
M_DECLARE_AST_LEAF_NODE_ENUM(binary_operator,
...
M_DECLARE_AST_LEAF_NODE_ENUM(statement, IF, SWITCH,
		WHILE, FOR, DO);
M_DECLARE_AST_LEAF_NODE_ENUM(labeled_statement, LABEL, CASE, DEFAULT);
M_DECLARE_AST_LEAF_NODE_ENUM(jump_statement, GOTO, CONTINUE, BREAK, RETURN);
